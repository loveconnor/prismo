  ...
  template: `
    <section>
      <div class="mb-4 flex items-center justify-between">
        <h2 class="text-2xl font-semibold text-foreground">My Recent Labs</h2>
      </div>
        ...
        <ng-container *ngFor="let lab of recentLabs; let i = index">
          ...
          >
            ...
            <ng-container *ngIf="lab.status === 'completed'; else resumeTpl">
              <app-button variant="outline" className="min-w-[100px]">Review</app-button>
            </ng-container>
            <ng-template #resumeTpl>
              <app-button className="min-w-[100px]">Resume</app-button>
            </ng-template>
          </div>
        </ng-container>
      </div>
